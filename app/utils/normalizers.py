...
def _normalize_video_lab_state(video_lab: Any) -> Dict[str, Any]:
    ...
    return {
        ...
        "audio_url": _as_text(video_lab.get("audio_url")),
        "audio_mix_url": _as_text(video_lab.get("audio_mix_url")),
        "audio_mix_source_url": _as_text(video_lab.get("audio_mix_source_url")),
